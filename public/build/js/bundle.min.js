...
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var deleteBtn = document.getElementById("delete-note");

    // TEMPORAL — Mismas notas de prueba
    var notes = [{
      id: "1",
      title: "Tarea de JavaScript",
      content: "Aprender funciones"
    }, {
      id: "2",
      title: "Compras",
      ...
      content: "App de notas con Firebase"
    }];
...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function _loadLanguage() {
      _loadLanguage = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(lang) {
        var res, _t;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              _context2.p = 0;
              _context2.n = 1;
              return fetch("/lang/".concat(lang, ".json"));
            case 1:
              res = _context2.v;
              _context2.n = 2;
              return res.json();
            ...
            case 3:
              _context2.p = 3;
              _t = _context2.v;
              console.error("Error cargando ".concat(lang, ".json"), _t);
    ...
    function _setLanguage() {
      _setLanguage = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(lang) {
        var langData;
    ...
    if (langBtn) {
      langBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var newLang;
...
(function () {
  ...
  createBtn.innerHTML = notes.length === 0 ? '<span class="btn-icon" >📝</span><span class="btn-text" data-i18n="create_note">¡Crea tu primera nota!</span>' : '<span class="btn-icon">➕</span><span class="btn-text" data-i18n="create_note">Crea una nota!</span>';
})();
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderNotes(filteredNotes) {
      ...
      filteredNotes.forEach(function (note) {
        ...
        li.innerHTML = "\n                <div class=\"info\">\n                    <h3>".concat(note.title, "</h3>\n                    <p>").concat(note.content.substring(0, 60), "...</p>\n                </div>\n\n                <div class=\"actions\">\n                    <button class=\"edit-btn\" data-id=\"").concat(note.id, "\">\u270F Editar</button>\n                    <button class=\"delete-btn\" data-id=\"").concat(note.id, "\">\uD83D\uDDD1 Eliminar</button>\n                </div>\n            ");
    ...
    resultsContainer.addEventListener("click", function (e) {
      if (e.target.classList.contains("edit-btn")) {
        ...
        window.location.href = "/editar/".concat(id);
      }
    });
  });
})();
...
/* harmony import */ var _menuHamburguesa_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./menuHamburguesa.js */ "./src/js/menuHamburguesa.js");
/* harmony import */ var _menuHamburguesa_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_menuHamburguesa_js__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _acc_sett_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./acc&sett.js */ "./src/js/acc&sett.js");
/* harmony import */ var _acc_sett_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_acc_sett_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _dark_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dark.js */ "./src/js/dark.js");
/* harmony import */ var _dark_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_dark_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _lang_auto_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lang-auto.js */ "./src/js/lang-auto.js");
/* harmony import */ var _lang_auto_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_lang_auto_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _crear_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./crear.js */ "./src/js/crear.js");
/* harmony import */ var _crear_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_crear_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _editar_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editar.js */ "./src/js/editar.js");
/* harmony import */ var _editar_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_editar_js__WEBPACK_IMPORTED_MODULE_7__);
