export default {
  ...
  //traduction bottons of account&settings.ejs
    ...
    migrateNotesTitle: "Would you like to migrate the notes from the guest to this account?",
    migrateNotesText: "This will migrate your notes (guest) from local storage to your account in the cloud.",
    confirmMigrate: "Yes, migrate!",
    cancelMigrate: "No, I´m not interested.",
