export default {
  ...
  //traduccion botones de account&settings.ejs 
    ...
    migrateNotesTitle: "¿Te gustaría migrar las notas del invitado a esta cuenta?",
    migrateNotesText: "Esto migrará tus notas (invitado) del almacenamiento local a tu cuenta en la nube.",
    confirmMigrate: "¡Sí, migrar!",
    cancelMigrate: "No, no estoy interesado.",
